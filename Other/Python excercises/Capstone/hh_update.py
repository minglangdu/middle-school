...
Started to try to make this work 11/25/24
...
class Loop(tkinter.Canvas): # used to manage the game's mainloop, not using its graphics
    def __init__(self, root):
        super().__init__(root)
        self.bind_all('<B>', self.build)
