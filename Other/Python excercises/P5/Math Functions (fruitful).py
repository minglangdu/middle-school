...
def vol_sphere(r):
    ...
    string
    """
    return "volume of sphere: " + str(round((((4/3) * math.pi * (r ** 3))) * 10) / 10) + " units"
...
def cel_to_fah(celsius):
    ...
    string
    """
    return "temperature: " + str((celsius * (9 / 5)) + 32) + " degrees fahrenheit"
...
def ft_in_to_cm(feet, inches):
    ...
    return "centimeters, rounded: " + str(feet_cm + inches_cm)
...
def invest_value(start_value, years, int_rate):
    ...
    string
    """
    return "End value: " + str(round(start_value * ((1 + (int_rate / 100)) ** years))) + " dollars"
    
def main():
    """In function to satisfy pylint."""
    print(vol_sphere(2))
    print(cel_to_fah(10))
    print(ft_in_to_cm(5, 3))
    print(invest_value(20000, 30, 5))
